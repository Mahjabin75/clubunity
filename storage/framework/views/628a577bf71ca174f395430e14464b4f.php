...
<section>
    <div class="album container mt-5">
        <div class="col-12">
            <h1 class="text-uppercase text-center clr pb-4">All Clubs with the name "<?php echo e($query); ?>"</h1>
        </div>
        <div class="row">
...
<?php echo $__env->make('include', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\websites\club\resources\views/search.blade.php ENDPATH**/ ?>