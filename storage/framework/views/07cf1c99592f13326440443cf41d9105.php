...
<div class="text-center mt-5">
  <img style="width: 200px;" class="logo" src="<?php echo e(asset('assets/images/logo.png')); ?>" alt="LOGO">

</div>

<section id="form">

        <form  class="col s12" action="<?php echo e(route('login-submit')); ?>" method="POST">
                <?php echo csrf_field(); ?>
        ...
        <form  class="col s12" action="<?php echo e(route('reg-submit')); ?>" method="POST">
        <?php echo csrf_field(); ?>
            <div class="text-center mt-3">
...
</html><?php /**PATH D:\xampp\htdocs\websites\club\resources\views/login.blade.php ENDPATH**/ ?>